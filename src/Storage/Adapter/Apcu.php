    ...
    TotalSpaceCapableInterface
{
    ...
    {
        $enabled = ini_get('apc.enabled') && class_exists('APCuIterator', false);
        if (PHP_SAPI == 'cli') {
        ...
        if (!$enabled) {
            throw new Exception\ExtensionNotLoadedException(
                "ext/apcu is disabled - see 'apc.enabled' and 'apc.enable_cli' or version is < 5.1"
            );
        }
    ...
    /**
     * Normalize metadata to work with APCu
     *
